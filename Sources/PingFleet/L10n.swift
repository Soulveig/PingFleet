...
enum L10n {
    ...
    static let releaseNotes = text("Release Notes", "История версий")
    ...
    static let updatesNotConfiguredMessage = text("Add an HTTPS update manifest URL to MTUpdateManifestURL in Info.plist or the UpdateManifestURL user default.", "Добавьте HTTPS URL манифеста в MTUpdateManifestURL в Info.plist или в UserDefaults UpdateManifestURL.")
