...
```sh
VERSION=0.2.11 UPDATE_MANIFEST_URL=https://api.github.com/repos/Soulveig/PingFleet/releases/latest ./Scripts/package-app.sh
```
...
1. Create a GitHub release such as `v0.2.11`.
2. Attach the notarized `PingFleet-0.2.11.zip` asset.
